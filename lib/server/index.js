...
var example_html_1 = require("../templates/example.html");
...
var WEB_MIDI_LIB_PATH = '/node_modules/webmidi/webmidi.min.js';
var BROWSER_WORKER_SCRIPT_PATH = '/lib/worker.js';
var BROWSER_SCRIPT_PATH = '/lib/browser.js';
var OSC_BROWSER_SCRIPT_PATH = '/node_modules/osc/dist/osc-browser.js';
var TONAL_BROWSER_SCRIPT_PATH = '/node_modules/tonal/build/transpiled.js';
var TONE_LIB_BROWSER_SCRIPT = '/node_modules/tone/build/Tone.min.js';
...
function startServer(opts) {
    ...
    var SERVER_PATH = path.resolve(serverPath);
    ...
    app.get('/', function (req, res) {
        res.send(example_html_1.exampleTemplate({
            BUFFER_PATH: b,
            USE_BROWSER_CLOCK: USE_BROWSER_CLOCK,
            ASCII_TEXT: ascii_1.ASCII_TEXT,
        }, [
