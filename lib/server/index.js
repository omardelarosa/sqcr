...
function startServer(opts) {
    var _a = opts.port, port = _a === void 0 ? 8081 : _a, serverPath = opts.serverPath, currentDir = opts.currentDir, buffers = opts.buffers, useServerClock = opts.useServerClock, configPath = opts.configPath;
