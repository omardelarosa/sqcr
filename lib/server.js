...
System.register("templates/example.html", [], function (exports_1, context_1) {
    "use strict";
    var exampleTemplate;
...
System.register("server/index", ["path", "express", "ws", "lodash", "templates/example.html"], function (exports_2, context_2) {
    ...
    exports_2("startServer", startServer);
    return {
        setters: [
            function (path_1_1) {
                path_1 = path_1_1;
            ...
            function (example_html_1_1) {
                example_html_1 = example_html_1_1;
            }
        ],
        execute: function () {
            osc = require('osc');
